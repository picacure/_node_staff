(function ($) {
    ...
    function pcHandler() {
        ...
        //xAlpha
        xAlpha = new Draw('xAlpha', { color: 'red', height: 200, width: '100%' });

        //yAlpha
        yAlpha = new Draw('yAlpha', { color: 'red', height: 200, width: '100%' });
    ...
    function drawLine(data) {
        ...
        if (!swc) {
            ...
            xFitPoints.push({
                x: hAxis,
                y: data.Shake.shakeArg.deltaX + vBase
            });

            if (xFitPoints.length > 20) {
                xFitDraw.drawLines(Fit.smoothing(xFitPoints, vBase));
                xFitPoints.splice(0, xFitPoints.length - 1);
            }
            ...
            xAlpha.drawLine(hAxis, data.Shake.shakeArg.deltaX * 30 + vBase);
            yAlpha.drawLine(hAxis, data.Shake.shakeArg.deltaY * 30 + vBase);
    ...
    $('figure').on('click', function (e) {
        ...
        var cObj = domObjMap[$(this).parent().attr('id')];
