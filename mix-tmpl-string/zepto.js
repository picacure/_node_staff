...
window.Zepto = Zepto, "$"in window || (window.$ = Zepto), function (a) {
        ...
        return this.each(function (e, f) {
            i(f, c, d, b, function (c) {
                return function (d) {
                    ...
                    return g ? (e = a.extend(k(d), {currentTarget: g, liveFired: f}), c.apply(g, [e].concat([].slice.call(arguments, 1)))) : void 0
                }
            })
        })
    ...
    a.each(o, function (a, c) {
        ...
        if (e === b && (e = .4), a.fx.off && (e = 0), "string" == typeof d)t[k] = d, t[l] = e + "s", t[m] = f || "linear", w = a.fx.animationEnd; else {
            p = [];
        ...
        }, e > 0 && this.bind(w, q), this.size() && this.get(0).clientLeft, this.css(t), 0 >= e && setTimeout(function () {
            v.each(function () {
                q.call(this)
            })
        }, 0), this
